# Приложение для расчёта геометрической задачи для варианта №10

Приложение должно позволять по введённым координатам двух вершин равнобедренного прямоугольного треугольника
$(x_1, y_1)$ и $(x_2, y_2)$, концов гипотенузы, вычислять координаты третьей вершины, а также координаты центра и
радиус вписанной в этот треугольник окружности. Приложение должно выводить оба возможных варианта.
...
* координаты всех трёх вершин треугольника для первого варианта;
* координаты центра и радиус вписанной в треугольник окружности для первого варианта;
* координаты всех трёх вершин треугольника для второго варианта;
* координаты центра и радиус вписанной в треугольник окружности для второго варианта.
